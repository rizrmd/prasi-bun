...
})({"9vtUI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DiffEditor", ()=>we);
parcelHelpers.export(exports, "Editor", ()=>de);
parcelHelpers.export(exports, "default", ()=>Ft);
parcelHelpers.export(exports, "loader", ()=>(0, _loaderDefault.default));
parcelHelpers.export(exports, "useMonaco", ()=>Le);
...
function Ee({ width: e, height: r, isEditorReady: n, loading: t, _ref: a, className: m, wrapperProps: E }) {
    return (0, _reactDefault.default).createElement("section", {
        style: {
            ...v.wrapper,
            width: e,
            height: r
        ...
        ...E
    }, !n && (0, _reactDefault.default).createElement($, null, t), (0, _reactDefault.default).createElement("div", {
        ref: a,
        style: {
            ...v.fullWidth,
            ...!n && v.hide
...
var ee = Ee;
var H = (0, _react.memo)(ee);
function Ce(e) {
    (0, _react.useEffect)(e, []);
}
var k = Ce;
function he(e, r, n = !0) {
    let t = (0, _react.useRef)(!0);
    (0, _react.useEffect)(t.current || !n ? ()=>{
        t.current = !1;
    } : e, r);
}
var l = he;
...
function Oe({ original: e, modified: r, language: n, originalLanguage: t, modifiedLanguage: a, originalModelPath: m, modifiedModelPath: E, keepCurrentOriginalModel: g = !1, keepCurrentModifiedModel: N = !1, theme: x = "light", loading: P = "Loading...", options: y = {}, height: V = "100%", width: z = "100%", className: F, wrapperProps: j = {}, beforeMount: A = D, onMount: q = D }) {
    let [M, O] = (0, _react.useState)(!1), [T, s] = (0, _react.useState)(!0), u = (0, _react.useRef)(null), c = (0, _react.useRef)(null), w = (0, _react.useRef)(null), d = (0, _react.useRef)(q), o = (0, _react.useRef)(A), b = (0, _react.useRef)(!1);
    k(()=>{
        let i = (0, _loaderDefault.default).init();
...
var ie = Oe;
var we = (0, _react.memo)(ie);
function Pe() {
    let [e, r] = (0, _react.useState)((0, _loaderDefault.default).__getMonacoInstance());
    return k(()=>{
        let n;
        return e || (n = (0, _loaderDefault.default).init(), n.then((t)=>{
            r(t);
        })), ()=>n?.cancel();
    }), e;
}
...
function Ve({ defaultValue: e, defaultLanguage: r, defaultPath: n, value: t, language: a, path: m, theme: E = "light", line: g, loading: N = "Loading...", options: x = {}, overrideServices: P = {}, saveViewState: y = !0, keepCurrentModel: V = !1, width: z = "100%", height: F = "100%", className: j, wrapperProps: A = {}, beforeMount: q = D, onMount: M = D, onChange: O, onValidate: T = D }) {
    let [s, u] = (0, _react.useState)(!1), [c, w] = (0, _react.useState)(!0), d = (0, _react.useRef)(null), o = (0, _react.useRef)(null), b = (0, _react.useRef)(null), L = (0, _react.useRef)(M), U = (0, _react.useRef)(q), I = (0, _react.useRef)(), i = (0, _react.useRef)(t), f = se(m), Q = (0, _react.useRef)(!1), B = (0, _react.useRef)(!1);
    k(()=>{
        let p = (0, _loaderDefault.default).init();
    ...
    (0, _react.useEffect)(()=>{
        ...
        s,
        X
    ]), i.current = t, (0, _react.useEffect)(()=>{
...
var fe = Ve;
var de = (0, _react.memo)(fe);
var Ft = de;

},{"@monaco-editor/loader":"9AKKa","react":"ftK02","@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"9AKKa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./loader/index.js":"eem3i","@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"eem3i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ function configureLoader() {
    ...
    var require1 = window.require;
    require1.config(state.config);
    require1([
...
},{"../_virtual/_rollupPluginBabelHelpers.js":"2IW10","state-local":"hhsp8","../config/index.js":"kZ5PH","../validators/index.js":"73nBP","../utils/compose.js":"erSDU","../utils/deepMerge.js":"1ZqPg","../utils/makeCancelable.js":"2Q7H4","@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"2IW10":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"hhsp8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function _defineProperty(obj, key, value) {
    if (key in obj) Object.defineProperty(obj, key, {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"kZ5PH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var config = {
    paths: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"73nBP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utils/curry.js":"hP1Ue","../utils/isObject.js":"5OC1Y","@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"hP1Ue":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function curry(fn) {
    return function curried() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"5OC1Y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function isObject(value) {
    return ({}).toString.call(value).includes("Object");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"erSDU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"1ZqPg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _rollupPluginBabelHelpersJs = require("../_virtual/_rollupPluginBabelHelpers.js");
...
},{"../_virtual/_rollupPluginBabelHelpers.js":"2IW10","@parcel/transformer-js/src/esmodule-helpers.js":"lwmMb"}],"2Q7H4":[function(require,module,exports) {
...
//# sourceMappingURL=dist.1f9430ff.js.map
